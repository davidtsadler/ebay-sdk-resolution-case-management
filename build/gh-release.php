...
$owner = 'davidtsadler';
$repo = 'ebay-sdk-resolution-case-management';
...
assert(file_exists(__DIR__ . '/artifacts/dts-resolution-case-management.zip'));
assert(file_exists(__DIR__ . '/artifacts/dts-resolution-case-management.phar'));
...
$client->post(
    $uploadUrl . '/assets?name=dts-resolution-case-management.zip',
    array('Content-Type' => 'application/zip'),
    fopen(__DIR__ . '/artifacts/dts-resolution-case-management.zip', 'r')
)->send();

$client->post(
    $uploadUrl . '/assets?name=dts-resolution-case-management.phar',
    array('Content-Type' => 'application/phar'),
    fopen(__DIR__ . '/artifacts/dts-resolution-case-management.phar', 'r')
)->send();
