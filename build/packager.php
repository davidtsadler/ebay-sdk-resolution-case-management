...
$autoLoader = 'dts-resolution-case-management-autoloader.php';
...
$packager->createZip(__DIR__ . '/artifacts/dts-resolution-case-management.zip');
$packager->createPhar(__DIR__ . '/artifacts/dts-resolution-case-management.phar', null, $autoLoader);
